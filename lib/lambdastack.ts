...
interface LambdaStackProps extends StageProps {
    stageName?: string;
    customEnv?: 'dev';// Optional stageName property
}
...
export class LambdaStack extends Stack {
    constructor(scope: Construct, id: string, props: LambdaStackProps) {
        ...
        const exampleLambda = new lambda.Function(this, 'lambda_function', {
            functionName: `lambda_function_${props.customEnv}`,  // Function name will be 'lambda_function_dev' or 'lambda_function_prod
